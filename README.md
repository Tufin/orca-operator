...
3. The operator parameters can be also found when logging into Orca: The domain and project are displayed at the top of every Orca screen and the agent token can be found in Settings
