...
import (
	...
	networkingv1 "github.com/tufin/orca-operator/pkg/apis/networking/v1"
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &networkingv1.Policy{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
...
func (r *ReconcilePolicy) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	if instance.Status.Phase != common.StatusReady {
...
func (r *ReconcilePolicy) UpdateStatus(instance *networkingv1.Policy, status string) error {
